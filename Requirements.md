...
| Функция | Требования | 
|:---|:---|
| Проверка одного файла | Приложение должно предоставить пользователю возможность проверить целостность любого файла |
| <a name="registration_requirements"/>Проверка файловой системы | Приложение должно предоставить пользователю возможность проверить целостность всех файлов любого каталога |
...
### 3.2.3 Ограничения
1. Приложение реализовано под Windows 10 с использованием языка C++.