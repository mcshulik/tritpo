...
| <a name="registration_requirements"/>Проверка всех файлов выбранного каталога | Приложение должно предоставить пользователю возможность проверить целостность всех файлов выбранного каталога |
